...
const Hero = () => {
  return (
    <div
      id="hero"
      className="h-[75vh] md:h-screen w-full bg-[url('/img/page/bg-image.png')] bg-cover bg-no-repeat"
    >
      <div className="grid h-[75vh] md:h-screen px-4">
        <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center">
          ...
          <h1 className="block antialiased tracking-normal xs:text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight text-white lg:max-w-3xl">
            IMPACTO INOVAÇÃO IA
          </h1>

          <p className="block antialiased xs:text-3xl sm:text-3xl  font-normal leading-relaxed text-white mb-12 w-full md:max-w-full">
